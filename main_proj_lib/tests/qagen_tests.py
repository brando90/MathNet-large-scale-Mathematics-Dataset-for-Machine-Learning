...
class TestQAGen(unittest.TestCase):
    ...
    def test_create_all_variables(self):
        ...
        self.assertEqual(len(qa.sympy_vars), len(set(qa.sympy_vars)))
        self.assertEqual(len(qa.names), len(set(qa.names))) 
    ...
    def test_reset_variables_states(self):
        ...
        self.assertEquals(len(qag.names), 0)
        self.assertEquals(len(qag.sympy_vars), 0)
