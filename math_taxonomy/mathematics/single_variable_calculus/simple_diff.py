...
class QA_constraint(QAGen):
    ...
    def __init__(self):
        ...
        self.description = '''Differentiate the expression with respect to x. x^{2} + x + 1'''
        # keywords about the question that could help to make this more searchable in the future
        self.keywords = ['single variable calculus']
        self.use_latex = True
    ...
    def init_qa_variables(self):
        ...
        """
        if self.debug:
            a_val, b_val, c_val = 2, 1, 1
        else:
            a_val, b_val, c_val = np.random.randint(1, 99, [3])
        return a_val, b_val, c_val

    def Q(s, a_val, b_val, c_val, x, a, b, c):
        """
    ...
    def A(s, a_val, b_val, c_val, x, a, b, c):
        """
        ...
        answer2 = seqg(expression, 'differentiated with respect to x is', answer)
