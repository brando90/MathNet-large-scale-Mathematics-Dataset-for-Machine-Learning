...
class QA_constraint(QAGen):
    ...
    def __init__(self):
        ...
        self.description = '''Let a be the 2 x 2 matrix [[1, -3], [4, 3]]. Let b be the 2 x 2 matrix [[0, -8], [30, -17]]. Find the matrix x if ax = b.'''
