...
class QA_constraint(QAGen):
    ...
    def __init__(self):
        ...
        self.description = '''Find the angle between the 3-d vectors v = (1, 2, -4) and u = (3, -1, 5)'''
    ...
    def A(s, a_val, b_val, c_val, d_val, e_val, f_val, v, u):
        ...
        answer1 = seqg('The angle between the 3-d vectors {0} = ({1}, {2}, {3}) and {4} = ({5}, {6}, {7})'.format(v, a_val, b_val, c_val, u, d_val, e_val, f_val), 'is {0} degrees'.format(answer))
        a = choiceg(answer1)
        return a
