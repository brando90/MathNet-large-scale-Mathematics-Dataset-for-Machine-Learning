...
class QA_constraint(QAGen):
    ...
    def __init__(self):
        ...
        self.description = '''Find the dot product of the 3-d vectors v = (1, 2, -4) and u = (3, -1, 5)'''
    ...
    def init_qa_variables(self):
        ...
        """
        if self.debug:
            a_val, b_val, c_val, d_val, e_val, f_val = 1, 2, -4, 3, -1, 5
        else:
            a_val, b_val, c_val, d_val, e_val, f_val = np.random.randint(-5, 5, [6])
        return a_val, b_val, c_val, d_val, e_val, f_val

    def Q(s, a_val, b_val, c_val, d_val, e_val, f_val, v, u):
        """
        ...
        question1 = seqg('Find the dot product of the 3-d vectors {0} = ({1}, {2}, {3}) and {4} = ({5}, {6}, {7})'.format(v, a_val, b_val, c_val, u, d_val, e_val, f_val))
        q = choiceg(question1)
        return q

    def A(s, a_val, b_val, c_val, d_val, e_val, f_val, v, u):
        """
        ...
        seqg, perg, choiceg = s.seqg, s.perg, s.choiceg
        answer = a_val * d_val + b_val * e_val + c_val * f_val
        answer1 = seqg(answer, 'is the dot product of the 3-d vectors {0} = ({1}, {2}, {3}) and {4} = ({5}, {6}, {7})'.format(v, a_val, b_val, c_val, u, d_val, e_val, f_val))
        a = choiceg(answer1)
        return a
