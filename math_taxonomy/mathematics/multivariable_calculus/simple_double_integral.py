...
class QA_constraint(QAGen):
    ...
    def __init__(self):
        ...
        self.description = '''Let R be the rectangle [1, 2] x [3, 5] in the x, y coordinate system. Calculate the integral of the function x y^{2} over the region R.'''
    ...
    def Q(s, a_val, b_val, c_val, d_val, e_val, f_val, x, y):
        ...
        ask = seqg('What is the integral of the function', expression, 'over the region R?')
        ask2 = seqg('What is the value of the function', expression, 'integrated over the region R?')
    ...
    def A(s, a_val, b_val, c_val, d_val, e_val, f_val, x, y):
        """
