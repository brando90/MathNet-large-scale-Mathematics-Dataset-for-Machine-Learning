...
class QA_constraint(QAGen):
    ...
    def __init__(self):
        ...
        self.description = '''Find a unit vector that is perpendicular to both vectors v = (3, 4, 5) and u = (2, 6, 7).'''
    ...
    def init_qa_variables(self):
        ...
        """
        if self.debug:
            a, b, c, d, e, f = 3, 4, 5, 2, 6, 7
        else:
            a, b, c, d, e, f = np.random.randint(-100, 100, [6])
        return a, b, c, d, e, f

    def Q(s, a, b, c, d, e, f, v, u):
        """
        ...
        calc = seqg('Find a unit vector that is perpendicular to both vectors {0} = ({1}, {2}, {3}) and {4} = ({5}, {6}, {7}).'.format(v, a, b, c, u, d, e, f))
        ask = seqg('What is a unit vector that is perpendicular to both vectors {0} = ({1}, {2}, {3}) and {4} = ({5}, {6}, {7})?'.format(v, a, b, c, u, d, e, f))
        q = choiceg(calc, ask)
        return q

    def A(s, a, b, c, d, e, f, v, u):
        """
        ...
        ans2 = c * d - a * f
        ans3 = a * e - b * d
        vector = (ans1, ans2, ans3)
        mag = sqrt(ans1**2 + ans2**2 + ans3**2)
        answer = (vector[0]/mag, vector[1]/mag, vector[2]/mag)
        answer1 = seqg('A unit vector perpendicular to both vectors {0} and {1} is {2}.'.format(v, u, answer))
        answer2 = seqg('{0} is a unit vector perpendicular to both vectors {1} and {2}.'.format(answer, v, u))
