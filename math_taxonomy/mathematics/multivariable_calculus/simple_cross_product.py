...
class QA_constraint(QAGen):
    ...
    def __init__(self):
        ...
        self.description = '''Find the cross product of the vectors v = (-1, 4, 3) and u = (2, -5, 1).'''
    ...
    def Q(s, a, b, c, d, e, f, v, u):
        ...
        calc = seqg('Find the cross product of the vectors {0} = ({1}, {2}, {3}) and {4} = ({5}, {6}, {7}).'.format(v, a, b, c, u, d, e, f))
        ask = seqg('What is the cross product of the vectors {0} = ({1}, {2}, {3}) and {4} = ({5}, {6}, {7})?'.format(v, a, b, c, u, d, e, f))
        q = choiceg(calc, ask)
        return q
    ...
    def A(s, a, b, c, d, e, f, v, u):
        ...
        answer1 = seqg('The cross product of the vectors {0} and {1} is {2}.'.format(v, u, answer))
        answer2 = seqg('{0} is the cross product of the vectors {1} and {2}.'.format(answer, v, u))
