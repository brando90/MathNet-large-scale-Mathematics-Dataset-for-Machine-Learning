...
class QA_constraint(QAGen):
    ...
    def __init__(self):
        ...
        self.description = '''Let P be the plane that goes through (1, 1, 1), (0, 0, 2), and (3, 0, 0) in the x, y, z coordinate plane. Find a vector normal to the plane P.'''
    ...
    def Q(s, a, b, c, d, e, f, g, h, i, x, y, z):
        ...
        calc = seqg('Find a vector normal to the plane P.')
        calc2 = seqg('Using a cross product, find a normal vector to the P.')
    ...
    def A(s, a, b, c, d, e, f, g, h, i, x, y, z):
        ...
        answer1 = seqg('A normal vector to P in the {0}, {1}, {2} plane is {3}.'.format(x, y, z, answer))
        answer2 = seqg('{0} is a normal vector to P in the {1}, {2}, {3} plane.'.format(answer, x, y, z))
