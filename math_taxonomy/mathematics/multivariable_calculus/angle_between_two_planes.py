...
class QA_constraint(QAGen):
    ...
    def __init__(self):
        ...
        self.description = '''Let plane p be defined by the equation 3x + 2y + 6z = 8. Let plane q be defined by the equation 2x + 2y + -1z = 5. Find the angle between the two planes p and q.'''
    ...
    def init_qa_variables(self):
        ...
        """
        if self.debug:
            a, b, c, d, e, f, g, h = 3, 2, 6, 8, 2, 2, -1, 5
        else:
            a, b, c, d, e, f, g, h = np.random.randint(-100, 100, [8])
        return a, b, c, d, e, f, g, h

    def Q(s, a, b, c, d, e, f, g, h, x, y, z, p, q):
        """
        ...
        given1 = seqg('Let plane {7} be defined by the equation {0}{1} + {2}{3} + {4}{5} = {6}.'.format(a, x, b, y, c, z, d, p))
        given2 = seqg('Let plane {7} be defined by the equation {0}{1} + {2}{3} + {4}{5} = {6}.'.format(e, x, f, y, g, z, h, q))
        calc = seqg('Find the angle between the two planes {0} and {1}.'.format(p, q))
        ask = seqg('What is the angle between the two planes {0} and {1}?'.format(p, q))
    ...
    def A(s, a, b, c, d, e, f, g, h, x, y, z, p, q):
        """
        ...
        normal1 = (a, b, c)
        normal2 = (e, f, g)
        mag1 = sqrt(normal1[0]**2 + normal1[1]**2 + normal1[2]**2)
        mag2 = sqrt(normal2[0]**2 + normal2[1]**2 + normal2[2]**2)
        cos_angle = (a*e + b*f + c*g) / (mag1 * mag2)
        answer = sympy.acos(cos_angle)
        answer1 = seqg('The angle between the two planes is {0}.'.format(answer))
        answer2 = seqg('{0} is the angle between the two planes.'.format(answer))
