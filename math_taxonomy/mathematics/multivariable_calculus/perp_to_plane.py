...
class QA_constraint(QAGen):
    ...
    def __init__(self):
        ...
        self.description = '''Let a (1, 2, 3), b (3, 3, 5), and c (4, 8, 1) be points in space. Find a vector perpendicular to the plane determined by a, b, and c.'''
    ...
    def init_qa_variables(self):
        ...
        """
        if self.debug:
            d, e, f, g, h, i, j, k, l = 1, 2, 3, 3, 3, 5, 4, 8, 1
        else:
            d, e, f, g, h, i, j, k, l = np.random.randint(-100, 100, [9])
        return d, e, f, g, h, i, j, k, l

    def Q(s, d, e, f, g, h, i, j, k, l, a, b, c):
        """
        ...
        given = seqg('Let {0} ({1}, {2}, {3}), {4} ({5}, {6}, {7}), and {8} ({9}, {10}, {11}) be points in space.'.format(a, d, e, f, b, g, h, i, c, j, k, l))
        calc = seqg('Find a vector perpendicular to the plane determined by {0}, {1}, and {2}.'.format(a, b, c))
        ask = seqg('What is a vector that is perpendicular to the plane determined by {0}, {1}, and {2}?'.format(a, b, c))
        question1 = seqg(given, calc)
        question2 = seqg(given, ask)
        q = choiceg(question1, question2)
        return q

    def A(s, d, e, f, g, h, i, j, k, l, a, b, c):
        """
        ...
        seqg, perg, choiceg = s.seqg, s.perg, s.choiceg
        v, u = (g - d, h - e, i - f), (j - d, k - e, l - f)
        ans1 = v[1] * u[2] - v[2] * u[1]
        ans2 = v[2] * u[0] - v[0] * u[2]
        ans3 = v[0] * u[1] - v[1] * u[0]
        answer = (ans1, ans2, ans3)
        answer1 = seqg('A vector perpendicular to the plane is {0}.'.format(answer))
        answer2 = seqg('{0} is a vector perpendicular to the plane.'.format(answer))
