...
class QA_constraint(QAGen):
    ...
    def __init__(self):
        ...
        self.description = '''Let a (1, 2, 3), b (3, 3, 5), and c (4, 8, 1) be points in space. Find the area of the region as defined by a, b, and c.'''
    ...
    def Q(s, d, e, f, g, h, i, j, k, l, a, b, c):
        ...
        calc = seqg('Find the area of the region as defined by {0}, {1}, and {2}.'.format(a, b, c))
        ask = seqg('What is the area of the region as defined by {0}, {1}, and {2}?'.format(a, b, c))
    ...
    def A(s, d, e, f, g, h, i, j, k, l, a, b, c):
        ...
        mag = sqrt(ans1**2 + ans2**2 + ans3**2)
        answer = 1/2 * mag
        answer1 = seqg('The area of the region defined is {0}.'.format(answer))
        answer2 = seqg('{0} is the area of the region defined.'.format(answer))
