...
class QA_constraint(QAGen):
    ...
    def __init__(self):
        ...
        self.description = '''Let V be the volume defined by [1, 5] x [2, 3] x [0, 4] in the x, y, z coordinate system. Calculate the integral of the function x^{2} + y^{2} + z^{2} over the volume V.'''
    ...
    def init_qa_variables(self):
        ...
        """
        if self.debug:
            a_val, b_val, c_val, d_val, e_val, f_val, a, b, c = 1, 5, 2, 3, 0, 4, 2, 2, 2
        else:
            a_val, b_val, c_val, d_val, e_val, f_val, a, b, c = np.random.randint(-5, 5, [9])
        return a_val, b_val, c_val, d_val, e_val, f_val, a, b, c

    def Q(s, a_val, b_val, c_val, d_val, e_val, f_val, a, b, c, x, y, z):
        """
        ...
        ask = seqg('What is the integral of the function', expression, 'over the volume V?')
        ask2 = seqg('What is the value of the function', expression, 'integrated over the volume V?')
        question1 = seqg(given, calc)
        question2 = seqg(given, ask)
        question3 = seqg(given, ask2)
        q = choiceg(question1, question2, question3)
        return q

    def A(s, a_val, b_val, c_val, d_val, e_val, f_val, a, b, c, x, y, z):
        """
