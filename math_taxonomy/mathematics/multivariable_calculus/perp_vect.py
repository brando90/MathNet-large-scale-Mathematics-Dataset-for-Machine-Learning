...
class QA_constraint(QAGen):
    ...
    def __init__(self):
        ...
        self.description = '''Let the vectors u = (1, t, 2) and v = (t, 4, 4). What value of the parameter t makes these vectors orthogonal?'''
    ...
    def Q(s, a, b, c, d, u, v, t):
        ...
        given = seqg('Let the vectors {0} = ({1}, {2}, {3}) and {4} = ({2}, {5}, {6}).'.format(u, a, t, b, v, c, d))
        calc = seqg('Find the value of the parameter {0} that will make these vectors orthogonal.'.format(t))
        ask = seqg('What value of the parameter {0} makes these vectors orthogonal?'.format(t))
        question1 = seqg(given, ask)
        question2 = seqg(given, calc)
        q = choiceg(question1, question2)
        return q

    def A(s, a, b, c, d, u, v, t):
        """
        ...
        answer1 = seqg('The value of the parameter {0} is {1}.'.format(t, ans))
        answer2 = seqg('{0} is the value of the parameter {1}.'.format(ans, t))
