...
class QA_constraint(QAGen):
    ...
    def __init__(self):
        ...
        self.description = '''Let P be the plane that goes through (1, 1, 1), (0, 0, 2), and (3, 0, 0) in the x, y, z coordinate plane. Find an equation for the plane P.'''
    ...
    def Q(s, a, b, c, d, e, f, g, h, i, x, y, z):
        ...
        given = seqg('Let P be the plane that goes through ({0}, {1}, {2}), ({3}, {4}, {5}), and ({6}, {7}, {8}) in the {9}, {10}, {11} coordinate plane.'.format(a, b, c, d, e, f, g, h, i, x, y, z))
        calc = seqg('Find an equation for the plane P.')
        ask = seqg('What is an equation for the plane P?')
    ...
    def A(s, a, b, c, d, e, f, g, h, i, x, y, z):
        ...
        d_val = ans1 * a + ans2 * b + ans3 * c
        equation = ans1 * x + ans2 * y + ans3 * z
        answer1 = seqg('An equation for the plane P is {0} = {1}.'.format(equation, d_val))
        answer2 = seqg('{0} = {1} is an equation for the plane P.'.format(equation, d_val))
