...
class QA_constraint(QAGen):
    ...
    def init_qa_variables(self):
        ...
        return L_val, m_val, g_val

    def Q(s, L_val, m_val, g_val, L, y, m, g): #TODO change the signature of the function according to your question
        '''
        ...
        # TODO
        info_V1 = seqg('A rope with length {0} = {1} (m) and mass {2} = {3] (kg) is suspended'
    ...
    def A(s, L_val, m_val, g_val, L, y, m, g): #TODO change the signature of the function according to your answer
        '''
        T(y) = m/L*g*y
        ...
        #define some short cuts
        seqg, perg, choiceg = s.seqg, s.perg, s.choiceg
        coefficient = m_val/L_val * g_val
        answer_value = seqg('{0}*{1}'.format(coefficient, y))
        answer_symbol = seqg('({0}/{1})*{2}*{3}'.format(y, L, m, g))
