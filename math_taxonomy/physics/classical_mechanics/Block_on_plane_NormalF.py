...
class QA_constraint(QAGen):
    ...
    def __init__(self):
        ...
        self.description = 'A block sits on a plane that is inclined at an angle theta. Assume that the friction force is ' \
                           'large enough to keep the block at rest. What is the Normal force. '
    ...
    def Q(s, g_val, theta_val, m_val , g, theta, m): #TODO change the signature of the function according to your question
        ...
        'that the friction force is large enough to keep the block at rest. What is the normal force given its mass equal to,'
                          , Eq(m, m_val), ' (kg) and the gravitational acceleration is,', Eq(g, g_val), ' (m/s^2).')
        question_2 = seqg('An object with ', Eq(m, m_val), ' (kg) is sited on a plane that is inclined at an angle', Eq(theta, theta_val),
                          ' degree. We know that the the friction force is large enough to keep the block at rest. '
                          'What is the normal force. The gravitational acceleration is,', Eq(g, g_val), ' (m/s^2).')
        question_3 = seqg('There is an object in rest on a plane that is inclined at an angle. The mass of the object is'
                        ...
                        'What is the normal force if the gravitational acceleration is ,', Eq(g, g_val), ' (m/s^2).')
        #q_format2
        #...
    ...
    def A(s, g_val, theta_val, m_val , g, theta, m): #TODO change the signature of the function according to your answer
        ...
        answer_1 = seqg('The normal force is: ', ans,' (N).')
        answer_2 = seqg('The normal force is equal to the projection of wight perpendicular to the direction of the plane which is:', ans,' (N).')
        answer_3 = seqg('Normal force is equal to the projection of the weight perpendicular to the plane and this is irrelevant of the mass motion. Thus, the friction force is,', ans,' (N)')
        answer_4 = seqg('We know that the mass has no movement perpendicular to the plane so the normal force must be equal to the projection of the eight in that direction. As a result, normal force is  ', ans, ' (N).')
        answer_5 = seqg('We know that the mass has no movement perpendicular to the plane so the normal force must be equal to the projection of the eight in that direction. Thus, normal force is  ',
            ans, ' (N).')
        answer_6 = seqg('We know that the mass has no movement perpendicular to the plane so the normal force must be equal to the projection of the eight in that direction. Consequently, normal force is  ',
            ans, ' (N).')
