...
class QA_constraint(QAGen):
    ...
    def __init__(self):
        ...
        self.description = 'A block of mass m is held motionless on a frictionless plane of mass M and angle of' \
                           ...
                           'The block is released. What is the acceleration vector of the object?'
    ...
    def Q(s, m_val, M_val, g_val, theta_val, m, M, g, theta, a):
        ...
        wanted_V1 = seqg('What is the acceleration vector {0} of the object.'.format(a))
        wanted_V2 = seqg('Find the acceleration vector of the object, {0}.'.format(a))
        wanted_V3 = seqg('Calculate the acceleration vector of the object, {0}.'.format(a))
        wanted_V4 = seqg('Based on given information, find the acceleration vector of the object, {0}.'.format(a))
