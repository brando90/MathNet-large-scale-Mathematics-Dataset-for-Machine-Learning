...
class QA_constraint(QAGen):
    ...
    def __init__(self):
        ...
        self.description = 'Find the magnitude and direction of the electric field due to a particle with a charge of q = 5 nC at a point that lies d = 2 m away.'
    ...
    def init_consistent_qa_variables(self):
        ...
        """
        q, d = symbols('q d') # charge, distance
        return  q, d
    ...
    def init_qa_variables(self):
        ...
        if self.debug:
            ...
            q_val = np.random.uniform(-100 ,100)
            d_val = np.random.uniform(.001,100)

        return q_val, d_val

    def Q(s, q_val, d_val, q, d):
        '''
        ...
        question1 = seqg('Find the magnitude and direction of the electric field due to a particle with a charge of', Eq(q, q_val), 'nC at a point that lies', Eq(d, d_val),'m away.')
        question2 = seqg('Solve for the magnitude and direction of the electric field at a point lies a distance', Eq(d, d_val), 'm away from a particle of charge', Eq(q, q_val), 'nC')
        q = choiceg(question1, question2)
        return q

    def A(s,q_val, d_val, q, d):
        '''
        ...
        '''
        seqg, perg, choiceg = s.seqg, s.perg, s.choiceg
        efield = 8.988 * q_val/(d_val**2)
        if q_val > 0:
            direction = 'towards'
        else:
            direction = 'away from'
        answer1 = seqg('The magnitude of the electric field is', efield, 'N/C and it is directed', direction, 'the particle.')
        answer2 = seqg('The electric field is directed', direction, 'the particle and it has a magnitude of', efield, 'N/C.')
