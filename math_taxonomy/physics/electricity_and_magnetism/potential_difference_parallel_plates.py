...
class QA_constraint(QAGen):
    ...
    def init_consistent_qa_variables(self):
        ...
        """
        Q, C = symbols('Q C') # charge, distance
        return  Q, C
    ...
    def init_qa_variables(self):
        ...
        if self.debug:
            ...
            Q_val = np.random.uniform(.1, 100)
            C_val = np.random.uniform(1,10000)

        return Q_val, C_val

    def Q(s, Q_val, C_val, Q, C):
        '''
        ...
        question1 = seqg('What is the potential difference across a parallel-plate capacitor that has a capacitance of', C_val, 'pF and a charge of', Q_val, 'µC on each plate?')
        question2 = seqg('What is the potential difference across a parallel-plate capacitor that has a charge of', Q_val, 'µC and a capacitance of', C_val, 'pF on each plate?')
        question3 = seqg('In a parallel-plate capacitor that has a charge of', Q_val, 'µC and a capacitance of', C_val, 'pF on each plate, what is the potential difference across the plates?')
        question4 = seqg('In a parallel-plate capacitor that has a capacitance of', C_val, 'pF and a charge of', Q_val, 'µC on each plate, what is the potential difference across the plates?')
        q = choiceg(question1, question2, question3, question4)
        return q

    def A(s, Q_val, C_val, Q, C):
        '''
        ...
        '''
        seqg, perg, choiceg = s.seqg, s.perg, s.choiceg
        potential = Q_val*(10**6)/C_val
        answer1 = seqg('The potential difference across the plates is', potential, 'V.')
        answer2 = seqg(potential, 'V is the potential difference across the plates.')
