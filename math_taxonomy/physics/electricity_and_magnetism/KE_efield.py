...
class QA_constraint(QAGen):
    ...
    def __init__(self):
        ...
        self.keywords = ['physics', 'electricity and magnetism', 'electric field', 'kinetic energy']
        self.use_latex = True
    ...
    def Q(s,q_val,k_val, d_val, direction, q,k, d):
        ...
        form1 = seqg('''What is the electric potential of the particle's starting point with respect to its endpoint?''')
        form2 = seqg('''What is the electric potential of the starting point of the particle with respect to its endpoint?''')
        form3 = seqg('''With respect to the particle's endpoint, what is the potential of its starting point?''')
