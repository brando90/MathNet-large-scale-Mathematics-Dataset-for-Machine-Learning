...
class QA_constraint(QAGen):
    ...
    def Q(s, diameter_radius, diameter, a, b, l, e, R, I, Q, E, r):
        '''
        ...
        terms1 = seqg(perg(str(a) + ',', str(b) + ',', str(l) + ',', str(r) + ',', str(Q) + ','), 'and', str(R))
        terms2 = seqg(perg(str(R) + ',', str(b) + ',', str(l) + ',', str(r) + ',', str(Q) + ','), 'and', str(a))
        terms3 = seqg(perg(str(a) + ',', str(R) + ',', str(l) + ',', str(r) + ',', str(Q) + ','), 'and', str(b))
        terms4 = seqg(perg(str(a) + ',', str(b) + ',', str(R) + ',', str(r) + ',', str(Q) + ','), 'and', str(l))
        terms5 = seqg(perg(str(a) + ',', str(b) + ',', str(l) + ',', str(R) + ',', str(Q) + ','), 'and', str(r))
        terms6 = seqg(perg(str(a) + ',', str(b) + ',', str(l) + ',', str(r) + ',', str(R) + ','), 'and', str(Q))
        terms = choiceg(terms1,terms2,terms3,terms4,terms5,terms6)

        GG = seqg(Calculate, 'the magnitude of the electric field',E,'when r < a, r > b, and a < r < b, in terms of',str(a) + ',', str(b) + ',', str(l) + ',', str(r) + ',', str(Q) + ', and', str(R)+'.')
    ...
    def A(s, diameter_radius, diameter, a, b, l, e, R, I, Q, E, r):
        '''
        Important Note: first variables are the not consistent variables followed
        by the consistent ones. See sample QA example if you need too.
        '''
        ...
        efield1 = Eq(E, Q/(2*pi*r*l*epsilon_0))
        efield2 = Eq(Q/(2*pi*r*l*epsilon_0), E)
